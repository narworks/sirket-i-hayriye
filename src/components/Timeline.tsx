  ...
  return (
    <div ref={ref} className="relative flex w-full items-start">
      ...
      <div className="flex w-full md:hidden">
        ...
        >
          <span className="font-['Cinzel'] text-lg tracking-widest text-ottoman-gold">
            {event.year}
          </span>
          <h3 className="mt-1 font-['Playfair_Display'] text-2xl font-semibold text-ottoman-navy">
            {event.title}
          </h3>
          <p className="mt-2 font-['Source_Serif_4'] text-lg leading-relaxed text-ottoman-navy/60">
            {event.description}
          </p>
        </motion.div>
      </div>
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-16 text-center">
          <motion.span
            ...
            viewport={{ once: true }}
            className="font-['Cinzel'] text-lg tracking-[0.2em] text-ottoman-gold md:text-sm md:tracking-[0.3em]"
          >
            TARİHÇE
          </motion.span>
          <motion.h2
