    ...
    >
      <div className="mx-auto max-w-5xl">
        <div className="grid gap-12 md:grid-cols-5 md:items-center">
          ...
          >
            <span className="font-['Cinzel'] text-lg tracking-[0.2em] text-ottoman-gold md:text-sm md:tracking-[0.3em]">
              VİZYONER LİDER
            </span>
            <h2 className="mt-2 font-['Playfair_Display'] text-3xl font-bold text-ottoman-navy md:text-4xl">
              Hüseyin Haki Efendi
            </h2>
            <p className="mt-1 font-['Cinzel'] text-xl text-ottoman-navy/50 md:text-base">
              Şirket-i Hayriye Müdürü — 1867 – 1894
            </p>

            <OttomanDivider className="my-6 max-w-xs" />

            <div className="space-y-4 font-['Source_Serif_4'] text-xl leading-relaxed text-ottoman-navy/70 md:text-base">
              <p>
